...
function $StateProvider(   $urlRouterProvider,   $urlMatcherFactory) {
  ...
  var stateBuilder = {
    ...
    // inherit 'assets.data' from parent and override by own values (if any)
    data: function(state) {
   ...
   * - **assets.data** `{object}` - returns state assets.data, including any inherited assets.data that is not
   ...
   * <a id='assets.data'></a>
   *
   * - **`assets.data`** - {object=} - Arbitrary assets.data object, useful for custom configuration.
   *
   * @example
   * <pre>
   ...
   * you passed it in. Useful for accessing custom assets.data.
 ...
 * Given attributes and inherited $uiView assets.data, return the view's name
 */
